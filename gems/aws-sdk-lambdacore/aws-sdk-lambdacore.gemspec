...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-lambdacore'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AWS Lambda Core'
  spec.description   = 'Official AWS Ruby gem for AWS Lambda Core. This gem is part of the AWS SDK for Ruby.'
