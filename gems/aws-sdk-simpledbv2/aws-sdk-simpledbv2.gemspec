...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-simpledbv2'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Amazon SimpleDB v2'
  spec.description   = 'Official AWS Ruby gem for Amazon SimpleDB v2. This gem is part of the AWS SDK for Ruby.'
