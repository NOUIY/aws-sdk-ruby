...
module Aws::BedrockAgentRuntime
  module EventStreams
    class AgenticRetrieveStreamResponseOutput
      ...
      def on_response_event_event(&block)
        @event_emitter.on(:response_event, block) if block_given?
      end
      ...
      def on_trace_event_event(&block)
        @event_emitter.on(:trace_event, block) if block_given?
      end
