...
module Aws::SagemakerJobRuntime
  describe EndpointProvider do
    subject { Aws::SagemakerJobRuntime::EndpointProvider.new }
    ...
    context "For region us-east-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://job-runtime.sagemaker-fips.us-east-1.api.aws"}}
      end
    ...
    context "For region us-east-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://job-runtime.sagemaker.us-east-1.api.aws"}}
      end
    ...
    context "For region cn-northwest-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://job-runtime.sagemaker-fips.cn-northwest-1.api.amazonwebservices.com.cn"}}
      end
    ...
    context "For region cn-northwest-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://job-runtime.sagemaker.cn-northwest-1.api.amazonwebservices.com.cn"}}
      end
    ...
    context "For region us-gov-west-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://job-runtime.sagemaker-fips.us-gov-west-1.api.aws"}}
      end
    ...
    context "For region us-gov-west-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://job-runtime.sagemaker.us-gov-west-1.api.aws"}}
      end
