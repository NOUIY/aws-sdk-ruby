...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-novaact'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - Nova Act Service'
  spec.description   = 'Official AWS Ruby gem for Nova Act Service. This gem is part of the AWS SDK for Ruby.'
