...
module Aws::GeoRoutes
  describe EndpointProvider do
    ...
    context "For region us-east-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://routes.geo-fips.us-east-1.api.aws"}}
      end
    ...
    context "For region us-east-1 with FIPS enabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://routes.geo-fips.us-east-1.amazonaws.com"}}
      end
    ...
    context "For region us-east-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://routes.geo.us-east-1.api.aws"}}
      end
    ...
    context "For region us-east-1 with FIPS disabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://routes.geo.us-east-1.amazonaws.com"}}
      end
    ...
    context "For region us-gov-west-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://routes.geo-fips.us-gov-west-1.us-gov.api.aws"}}
      end
    ...
    context "For region us-gov-west-1 with FIPS enabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://routes.geo-fips.us-gov-west-1.us-gov.amazonaws.com"}}
      end
    ...
    context "For region us-gov-west-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://routes.geo.us-gov-west-1.us-gov.api.aws"}}
      end
    ...
    context "For region us-gov-west-1 with FIPS disabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"url" => "https://routes.geo.us-gov-west-1.us-gov.amazonaws.com"}}
      end
