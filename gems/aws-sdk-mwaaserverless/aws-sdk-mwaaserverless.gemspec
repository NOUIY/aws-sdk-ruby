...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-mwaaserverless'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - AmazonMWAAServerless'
  spec.description   = 'Official AWS Ruby gem for AmazonMWAAServerless. This gem is part of the AWS SDK for Ruby.'
