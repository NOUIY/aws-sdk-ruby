...
module Aws::TaxSettings
  describe EndpointProvider do
    ...
    context "For region eusc-de-east-1 with FIPS enabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"properties" => {"authSchemes" => [{"name" => "sigv4", "signingRegion" => "eusc-de-east-1"}]}, "url" => "https://tax-fips.eusc-de-east-1.amazonaws.eu"}}
      end
    ...
    context "For region eusc-de-east-1 with FIPS disabled and DualStack disabled" do
      let(:expected) do
        {"endpoint" => {"properties" => {"authSchemes" => [{"name" => "sigv4", "signingRegion" => "eusc-de-east-1"}]}, "url" => "https://tax.eusc-de-east-1.amazonaws.eu"}}
      end
