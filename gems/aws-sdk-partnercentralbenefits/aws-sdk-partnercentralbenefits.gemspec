...
Gem::Specification.new do |spec|
  ...
  spec.name          = 'aws-sdk-partnercentralbenefits'
  spec.version       = File.read(File.expand_path('../VERSION', __FILE__)).strip
  spec.summary       = 'AWS SDK for Ruby - PartnerCentral Benefits'
  spec.description   = 'Official AWS Ruby gem for Partner Central Benefits API (PartnerCentral Benefits). This gem is part of the AWS SDK for Ruby.'
